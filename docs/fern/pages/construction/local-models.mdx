...
Graph backend: Local model construction (light)
...
BCG starts the `light` Graph Construction server at `127.0.0.1:8848`; it does not start the vLLM process itself.
