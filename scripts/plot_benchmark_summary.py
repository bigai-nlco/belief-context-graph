...
def render_svg(output: Path) -> None:
    ...
    parts = [
        ...
        '<title id="title">10%+ Token Savings · Tractable Reasoning · Better Performance</title>',
        ...
        f'<text x="640" y="39" text-anchor="middle" fill="{TEXT_COLOR}" font-size="27" font-weight="700">10%+ Token Savings · Tractable Reasoning · Better Performance</text>',
