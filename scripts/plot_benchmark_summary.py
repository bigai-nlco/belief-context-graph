...
def render_svg(output: Path) -> None:
    ...
    parts = [
        ...
        '<title id="title">Less Tokens · Better Performance · Belief-Aware Reasoning</title>',
        ...
        f'<text x="640" y="39" text-anchor="middle" fill="{TEXT_COLOR}" font-size="27" font-weight="700">Less Tokens · Better Performance · Belief-Aware Reasoning</text>',
