...
const GITHUB_REPO = "bigai-nlco/belief-context-graph";
const CHANGELOG_LINK_BASE_PATH = "agent-cli";
const LEGACY_REPO_RE = /^https:\/\/github\.com\/bigai-nlco\/belief-context-graph(?=\/|$)/;
