	...
	const extensionFlagsText =
		extensionFlags && extensionFlags.length > 0
			? `\n${chalk.bold("Extension CLI Flags:")}\n${extensionFlags
					...
					.join("\n")}\n`
			: "";
	console.log(`${chalk.bold(APP_NAME)} - graph-backed terminal agent with coding and web tools
...
${chalk.bold("Commands:")}
  ...
  ${APP_NAME} update [source|self]      Update BCG Agent, extensions, or model catalogs
...
${chalk.bold("Environment Variables:")}
  ...
  SERPER_API_KEY                   - Serper API key for the web_search tool
