...
const PROJECT_URL = "https://github.com/bigai-nlco/belief-context-graph";
...
export class EarendilAnnouncementComponent extends Container {
	constructor() {
		...
		this.addChild(new Text(theme.bold(theme.fg("accent", "Belief Context Graph")), 1, 0));
		this.addChild(new Spacer(1));
		this.addChild(new Text(theme.fg("muted", "Project repository:"), 1, 0));
