...
import type { AgentMessage, StreamFn } from "@bigai-nlco/bcg-agent-core";
import type { RetryCallbacks, RetryPolicy } from "@bigai-nlco/bcg-ai";
import { contentText } from "@bigai-nlco/bcg-ai";
import type { Model, SimpleStreamOptions, Usage } from "@bigai-nlco/bcg-ai/compat";
import {
	convertToLlm,
...
export function prepareBranchEntries(entries: SessionEntry[], tokenBudget: number = 0): BranchPreparation {
	...
	// Only extract from bcg-generated summaries (fromHook !== true), not extension-generated ones
