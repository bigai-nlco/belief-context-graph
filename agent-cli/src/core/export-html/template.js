    (function() {
      ...
      const injectedParams = document.querySelector('meta[name="bcg-url-params"]');
      ...
      function buildShareUrl(entryId) {
        ...
        const baseUrlMeta = document.querySelector('meta[name="bcg-share-base-url"]');
      ...
      const SIDEBAR_WIDTH_STORAGE_KEY = 'bcg-share:v1:sidebar-width';
