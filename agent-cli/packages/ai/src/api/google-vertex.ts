...
import type {
	...
	Context,
	Model,
	ThinkingLevel as BCGThinkingLevel,
	ProviderEnv,
	ProviderHeaders,
	SimpleStreamOptions,
	StreamFunction,
...
type ClampedThinkingLevel = Exclude<BCGThinkingLevel, "xhigh" | "max">;
...
function getDisabledThinkingConfig(model: Model<"google-vertex">): ThinkingConfig {
	...
	// thinkingLevel without includeThoughts so hidden thinking remains invisible to bcg.
	const geminiModel = model as unknown as Model<"google-generative-ai">;
