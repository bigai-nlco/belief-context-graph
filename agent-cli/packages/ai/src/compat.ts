/**
 * Temporary compatibility entrypoint preserving the old global bcg-ai API
 ...
 *
 * Existing apps switch imports from "@bigai-nlco/bcg-ai" to
 * "@bigai-nlco/bcg-ai/compat" unchanged; new code uses `createModels()`
...
export * from "./api/bcg-messages.lazy.ts";
...
import { bcgMessagesApi } from "./api/bcg-messages.lazy.ts";
...
/** @deprecated Static catalog read. Use `getBuiltinModel` from "@bigai-nlco/bcg-ai/providers/all" or `Models.getModel()`. */
export const getModel = getBuiltinModel;

/** @deprecated Static catalog read. Use `getBuiltinModels` from "@bigai-nlco/bcg-ai/providers/all" or `Models.getModels()`. */
export const getModels = getBuiltinModels;

/** @deprecated Static catalog read. Use `getBuiltinProviders` from "@bigai-nlco/bcg-ai/providers/all" or `Models.getProviders()`. */
