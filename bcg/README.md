...
| Confidence policy | Config-driven prior + evidence + relation factor confidence in `confidence.py` | Role/stance prior table plus the same evidence and relation factor confidence fields in `confidence.py` |
