...
def launch_interactive(arguments: list[str] | None = None) -> int:
    ...
    if informational:
        ...
        from bcg.setup import ensure_user_setup
    ...
    if not informational:
        from bcg.setup import pending_login_provider
    ...
    if pending_login:
        from bcg.setup import mark_login_prompt_consumed
...
def main(arguments: list[str] | None = None) -> int:
    from bcg.setup import SetupError
