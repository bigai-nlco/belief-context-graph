...
from bcg.benchmark.loaders import (
    BENCHMARKS,
    BenchmarkDataError,
    canonical_name,
    load_benchmark,
)
from bcg.benchmark.runner import RunConfig, run_benchmarks
from bcg.benchmark.scoring import JudgeConfig, LLMJudge
...
def run(
    ...
    try:
        if "bcg" in resolved_modes:
            from bcg.agent_runtime import ensure_graph_server
